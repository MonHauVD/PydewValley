...
class Player(pygame.sprite.Sprite):
	def __init__(self, pos, group, collision_sprites, tree_sprites, interaction, soil_layer, toggle_shop, inventory_show):
	...
	def use_seed(self):
		if self.seed_inventory[self.selected_seed] > 0:
			seedAble = self.soil_layer.plant_seed(self.target_pos, self.selected_seed)
			if seedAble == True:
